 ...
 */
const erc20SablierProxyContract: ExtensionTypes.PnReferenceBased.IReferenceBased = {
...
/**
 * Creates the extensionsData to create the extension Sablier ERC20 proxy contract payment detection
 *
...
function createCreationAction(
  ...
  return ReferenceBased.createCreationAction(
    ExtensionTypes.ID.PAYMENT_NETWORK_ERC20_SABLIER_PROXY_CONTRACT,
    creationParameters,
    CURRENT_VERSION,
  );
}
...
export default erc20SablierProxyContract;
