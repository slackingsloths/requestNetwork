...
// TODO replace addresses once the contract is deployed
...
export default class PaymentNetworkERC20ProxyContract implements PaymentTypes.IPaymentNetwork {
   ...
   * TODO: refund streams not supported
  ...
  public async getBalance(
    ...
    try {
      ...
      if (refundAddress) {
        // TODO Refund should rely on ERC20 payment detection
      ...
      // TODO implement streams found with != 1 streamId error
